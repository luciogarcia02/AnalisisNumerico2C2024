...
#rm(categories)
sqldf()
categories <- sqldf(c("create table categories (
...
#rm(customers)
sqldf()
customers <- sqldf(c("create table customers (
...
#rm(employees)
sqldf()
employees <- sqldf(c("create table `employees` (
...
#rm(orders)
sqldf()
orders <- sqldf(c("create table `orders` (
...
#rm(orderdetails)
sqldf()
orderdetails <- sqldf(c("create table `orderdetails` (
...
#rm(products)
sqldf()
products <- sqldf(c("create table products (
...
#rm(shippers)
sqldf()
shippers <- sqldf(c("create table shippers (
...
#rm(suppliers)
sqldf()
suppliers <- sqldf(c("create table suppliers (
...
#Ejemplo para ejecutar una consulta SQL
